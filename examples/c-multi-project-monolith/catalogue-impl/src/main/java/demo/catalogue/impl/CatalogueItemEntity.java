...
public class CatalogueItemEntity implements Serializable {
    ...
    public static CatalogueItemEntity of(final NewCatalogueItem domain) {
        requireNonNull(domain);
        return new CatalogueItemEntity(domain.caption(), domain.description());
    }
    ...
    public CatalogueItem toDomain() {
        return map(entity -> new CatalogueItem(entity.id(), entity.caption(), entity.description()));
    }
    ...
    public String toString() {
        return "CatalogueItemEntity[id=%d, caption=%s, description=%s]"
